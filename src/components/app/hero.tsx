	...
	return (
		<div className='relative w-full h-full'>
			...
			<div className='absolute w-full h-full'>
				<img src='img/mobile_vector.png' className='md:hidden object-cover w-full h-full' alt='Mobile background vector' />
				<img src='img/desktop_vector.png' className='hidden md:block object-cover w-full h-full' alt='Desktop background vector' />
			</div>
			...
			<div className='container-custom relative z-10'>
				<div className='flex flex-col md:flex-row justify-between pt-16 xl:gap-0 gap-10'>
					...
					<div className='contain-inline-size basis-full flex flex-col items-center md:items-end gap-10 relative w-full'>
						<img src='/img/twitter-img.png' alt='Twitter testimonial' className='w-full mx-auto md:mx-0 max-w-[450px] lg:max-w-[500px]' />
						<img src='/img/hero-img.png' alt='Application screenshot' className='w-full mx-auto md:mx-0 max-w-[520px] md:max-w-[450px] lg:max-w-[600px]' />
						<img src='/img/arrow.png' alt='Decorative arrow' className='absolute -left-10 top-28 hidden md:block' />
					</div>
				</div>
			</div>
		</div>
